...
public class modificaDatos extends javax.swing.JFrame {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(BtnGuardar, javax.swing.GroupLayout.PREFERRED_SIZE, 286, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void cargarDatos(int num_cliente) {
       ...
       this.masco  = control.traerMascota(num_cliente);
        ...
        txtNomDue.setText(masco.getUnDuenio().getNombre());
        txtCelDue.setText(masco.getUnDuenio().getCelDuenio());
       ...
       if (masco.getAtencion_especial().equals("SI")) {
            cmbAtencionEsp.setSelectedIndex(1);
              ...
              if (masco.getAtencion_especial().equals("NO")){
                  cmbAtencionEsp.setSelectedItem(2);
              }  
            }
    }
